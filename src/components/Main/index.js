...
import { Gradient, Colored, Side, Block, Box, H3, Slide, Slides, Conditions, Size, Footer, Links, Card, AboutCard, Inner, CarouselBox, CarouselItem, Modes } from './styled';
    ...
    <Row around='xs' style={{ margin: '0 auto', /* maxWidth: '1280px',*/ overflow: 'hidden'}}>
      ...
      <Col xs={12} md={8} /* style={{ maxWidth: '860px' }} */>
        ...
        <Row>
          ...
          <Col xs={12} md={5}>
            <img src='images/document.png' style={{ width: '295px', margin: '35px auto 140px',
    display: 'block'}}/>
          </Col>
        </Row>
        <Conditions>
